  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto">
        {services.map((s, i) => (
          <FadeIn key={s.num} delay={i * 0.1} y={30} duration={0.7}>
            <div className="flex items-start gap-6 sm:gap-10 py-8 sm:py-10 md:py-12 border-b border-[rgba(12,12,12,0.15)] last:border-b-0">
              {/* Number */}
              <span
